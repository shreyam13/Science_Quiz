...
readyYN = raw_input ("Are you ready to take the quiz Answer Yes or No?")
print readyYN
if readyYN.lower() == "yes":
        ...
        print "\nOut of 10 questions asked, you got %d of them right." % (count)
        print "\nYou got %d percent." % (count / float(10) * 100)
        print "Congratulation " + name
        print "Try re-running the program and taking the quiz again"

else: print name + ", you did not answer yes, so the program will exit. Please try by re-running the program and answer yes"
